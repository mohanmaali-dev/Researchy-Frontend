...
function AddFollowUpPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
      <Link to="/follow-ups" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-primary-dark">
        <FiArrowLeft aria-hidden="true" /> Back to follow-ups
      </Link>
